...
df4 = pd.read_csv("../backend/data/book900k-1000k.csv")
df5 = pd.read_csv("../backend/data/book1000k-1100k.csv")
df = pd.concat([df1, df2, df3, df4, df5])
df = df.dropna(subset=["Description", "Language", "Id"])
df.to_csv("../backend/data/book_preprocessed.csv", index=False)
